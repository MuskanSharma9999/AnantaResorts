  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.listItem}>
          • 4 Welcome meal vouchers - a complimentary buffet/fixed meal for two
          pax.
        </Text>
        <Text style={styles.listItem}>
        ...
        <Text style={styles.listItem}>
          • One (1) certificate entitling the bearer to a Celebration bottle of
          Indian House Wine or Five Indian Beer (330ML) or Five Mocktails
        ...
        <Text style={styles.listItem}>
          • 4 Special room rate vouchers (Rs. 4500 + taxes) for The Baagh Ananta
          Elite, Ranthambore (every year).
        </Text>
        <Text style={styles.listItem}>
        ...
        <Text style={styles.listItem}>
          • 1 Bar celebration voucher - bar discount voucher of Rs. 1000/- every
          year (Indian house brands).
        </Text>
        <Text style={styles.listItem}>
      ...
      <GradientButton
        title="Join Club"
        onPress={() => console.log('join button Clicked')}
        style={{ marginTop: 20, marginBottom: 100, width: 350 }}
      ></GradientButton>
    </ScrollView>
  );
}
